...
namespace QArantine.Code.Test
{
    public class TestError
    {
        ...
        public List<KeyValuePair<string, object>> ExtraFieldsList => [..ExtraFields];
        ...
        [JsonConstructor]
        public TestError(string testName, string testCaseName, string testStepName, string errorID, string errorCategory, string errorDescription, Dictionary<string, object> extraFields)
        {
            TestName = testName;
            TestCaseName = testCaseName;
            TestStepName = testStepName;
