namespace QArantine.Code.QArantineGUI.StaticData
{
    ...
    {
        public static Dictionary<string, string> QArantineIconsDictionary { get; } = new Dictionary<string, string>
        {
            {"No_Image", "/Assets/QArantineGUI/Icons/No_Image.png"},

            {"QArantineLogo", "/Assets/QArantineGUI/Icons/qarantine.ico"},

            {"Clear", "/Assets/QArantineGUI/Icons/Clear.png"},
            ...
            {"AutoScroll_Enabled", "/Assets/QArantineGUI/Icons/AutoScroll_Enabled.png"},
            {"AutoScroll_Disabled", "/Assets/QArantineGUI/Icons/AutoScroll_Disabled.png"},

            {"ProfilingTools", "/Assets/QArantineGUI/Icons/profiling.png"},
            {"ProfMeasurements_Enabled", "/Assets/QArantineGUI/Icons/ProfMeasurements_Enabled.png"},
